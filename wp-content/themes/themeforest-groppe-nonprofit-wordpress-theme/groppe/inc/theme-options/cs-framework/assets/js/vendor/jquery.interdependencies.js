...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Groppe the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is gropped.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to groppe condition, true show always, false hide always
         *
         */
