 ...
 */
require_once GROPPE_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'groppe_register_required_plugins' );
 ...
 */
function groppe_register_required_plugins() {
	/*
    ...
    array(
	    'name'					=> 'Groppe Core',
	    'slug'     			=> 'groppe-core',
	    'source'				=> 'https://victorthemes.com/plugins/groppe-core.zip',
	    'required'			=> true,
