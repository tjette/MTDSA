...
if ($groppe_meta) {
  ...
  if($groppe_banner_type != 'hide-title-area') {
    $groppe_transparent_header = $groppe_transparent_header ? ' header-transparent' : ' dont-transparent';
  } else {
    $groppe_transparent_header = ' dont-transparent';
  }
  // Shortcode Banner Type
  $groppe_banner_type = ' '. $groppe_meta['banner_type'];
} else { $groppe_transparent_header = ' dont-transparent'; $groppe_banner_type = ''; }
...
?>
  ...
  <div class="grop-header_sticky grop-header_navigations <?php echo esc_attr( $groppe_sticky_header_class ); ?>">
    <div class="container">
      <div class="row">
